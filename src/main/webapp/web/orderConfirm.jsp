...
<div id="container" class="clear">
       ...
       <c:forEach items="${address}" var="address">
        <div id="addresId1" class="base_select">
            ...
            <i class="user_address">
                ${shen} ${shi} ${qu} ${addr }  ${address.recvPhone}
            </i>
        ...
        <div class="product_confirm">
          ...
          <c:forEach items="${carts }" var="cart">
            <ul class="item_detail">
                <li class="p_info">
                    <b><img style="width:99px;height:99px"  src="${pageContext.request.contextPath }${cart.goodsImage}"/></b>
                ...
                <li class="p_price">
                    <i>达内专属价</i>
                    <br/>
                    <span class="pro_price">￥<span class="ppp_price">${cart.goodsPrice }.00 </span></span>
                </li>
                <li class="p_count">X<span>${cart.num }</span></li>
    ...
    <!-- 结算条-->
    <div id="count_bar">
        <span class="go_cart"><a href="${pageContext.request.contextPath}/cart/list.do" >&lt;&lt;返回购物车</a></span>
...
<script>
    $(".go_pay").click(function () {
        location.href = "${pageContext.request.contextPath}/cart/pay.do";
    })
</script>
<script>
