...
<form action="pay_success.html" method="post" id="pay_form">
    <div id="container" class="clearfix" >
        ...
        <div class="pay_info">
            <b>支付金额：<i>${price}.00元</i></b><input type="hidden" name="payment" value="0.01"/>
            <span>支付订单：324235435 收款方：my商城</span><input type="hidden" name="orderId" />
        </div>
        ...
        <span class="pay_leftTime">
            剩余付款时间：<input type="button" value="倒计时" onclick="timeout()">
            <span id="time"></span>
            <!--获取待支付时间并更改订单状态-->
        </span>
